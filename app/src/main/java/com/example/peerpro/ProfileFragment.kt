...
class ProfileFragment : Fragment() {
  ...
  private lateinit var tutorSessionAdapter: ProfileTutorSessionCardAdapter
  private lateinit var notesAdapter: ProfileTutorSessionCardAdapter
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    tutorSessionAdapter = ProfileTutorSessionCardAdapter(emptyList())
    notesAdapter = ProfileTutorSessionCardAdapter(emptyList())
  ...
  private fun refreshProfile() {
    ...
    // Stop the refreshing animation and show the fragment
